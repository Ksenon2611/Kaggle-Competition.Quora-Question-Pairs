...
ss.fit(np.vstack((np.hstack((leaks, train_df_add, text_similarity)), np.hstack((test_leaks, test_df_add, test_text_similarity))))) # calc stats

leaks = ss.transform(np.hstack((leaks, train_df_add, text_similarity))) # apply std
test_leaks = ss.transform(np.hstack((test_leaks, test_df_add, test_text_similarity)))
